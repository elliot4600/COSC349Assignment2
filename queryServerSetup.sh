echo "Configuring query server"
echo " "

cd /var/www/html/
sudo rm -r index.html
sudo wget https://assignment2storage.s3.amazonaws.com/query/index.php
sudo wget https://assignment2storage.s3.amazonaws.com/query/style.css
cd ~/
